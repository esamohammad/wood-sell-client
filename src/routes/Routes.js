...
export const routes = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://wood-sell-server.vercel.app/items/${params.id}`)
            ...
            },
            {
                ...
                loader: () => fetch("https://wood-sell-server.vercel.app/products"),
            },
            {
                path: "/login",
                element: <Login></Login>,
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://wood-sell-server.vercel.app/bookings/${params.id}`)
            }, 
            {
